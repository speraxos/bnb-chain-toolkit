...
* [Explore Core Concepts](https://x402.gitbook.io/x402/core-concepts/http-402)
...
Learn more about service discovery in the [Bazaar documentation](https://x402.gitbook.io/x402/core-concepts/bazaar-discovery-layer).
...
* [x402 Bazaar documentation](https://x402.gitbook.io/x402/core-concepts/bazaar-discovery-layer) - Discover available services
...
3. Complete the payment using a compatible client, wallet, or automated agent. This typically involves signing a payment payload, which is handled by the client SDK detailed in the [Quickstart for Buyers](https://x402.gitbook.io/x402/getting-started/quickstart-for-buyers).
...
When using the CDP facilitator, your endpoints can be listed in the [x402 Bazaar](https://x402.gitbook.io/x402/core-concepts/bazaar-discovery-layer), our discovery layer that helps buyers and AI agents find services. To enable discovery:
...
Learn more about the discovery layer in the [Bazaar documentation](https://x402.gitbook.io/x402/core-concepts/bazaar-discovery-layer).
...
See [Network Support](https://x402.gitbook.io/x402/core-concepts/network-and-token-support) for the full list.
...
* Get started as a [buyer](https://x402.gitbook.io/x402/getting-started/quickstart-for-buyers)
* Learn about the [Bazaar discovery layer](https://x402.gitbook.io/x402/core-concepts/bazaar-discovery-layer)
...
**Q: How do I get my service listed?** A: If you're using the CDP facilitator, your service is listed once you enable the bazaar extension with `discoverable: true`.

**Q: How can I make endpoint calls more accurate?** A: Include descriptions clearly stating what each parameter does and how to call your endpoint, but do so as succinctly as possible.

**Q: How does pricing work?** A: Listing is free. Services set their own prices per API call, paid via x402.

**Q: What networks are supported?** A: Currently Base (`eip155:8453`) and Base Sepolia (`eip155:84532`) with USDC payments.

**Q: Can I list non-x402 services?** A: No, only x402-compatible endpoints can be listed. See our [Quickstart for Sellers](https://x402.gitbook.io/x402/getting-started/quickstart-for-sellers) to make your API x402-compatible.
...
* [Learn about building x402 servers](https://x402.gitbook.io/x402/getting-started/quickstart-for-sellers)
...
* [Quickstart for Buyers](https://x402.gitbook.io/x402/getting-started/quickstart-for-buyers)
* [Quickstart for Sellers](https://x402.gitbook.io/x402/getting-started/quickstart-for-sellers)
* [Network and Token Support](https://x402.gitbook.io/x402/core-concepts/network-and-token-support)
